...
public class CourtQueue {
    ...
    public CourtQueue(Location courtLocation, CourtType courtType) {
        ...
        this.playersPerTeam = courtType == CourtType.ONES ? 1 : (courtType == CourtType.TWOS ? 2 : 3);
    ...
    /**
     * Constructor with manual spot locations (for 1v1 courts)
     */
    public CourtQueue(Location courtLocation, CourtType courtType, Location homeSpot, Location awaySpot) {
        this.courtLocation = courtLocation;
        this.courtType = courtType;
        this.playersPerTeam = 1;
        this.spots = new ArrayList<>();
        
        // Create spots at specified locations
        spots.add(new CourtSpot(homeSpot, CourtSpot.SpotType.TEAM1, this, 0));
        spots.add(new CourtSpot(awaySpot, CourtSpot.SpotType.TEAM2, this, 0));
    }
    
    /**
     * Simplified constructor for 1v1 courts with manual spot locations (no enum needed externally)
     */
    public CourtQueue(Location courtLocation, Location homeSpot, Location awaySpot) {
        this.courtLocation = courtLocation;
        this.courtType = CourtType.ONES;
        this.playersPerTeam = 1;
        this.spots = new ArrayList<>();
    ...
    /**
     * Simplified constructor for 2v2 and 3v3 courts (no enum needed externally)
     * @param courtLocation the center of the court
     * @param playersPerTeam 2 for 2v2, 3 for 3v3
     */
    public CourtQueue(Location courtLocation, int playersPerTeam) {
        this.courtLocation = courtLocation;
        this.courtType = playersPerTeam == 2 ? CourtType.TWOS : CourtType.THREES;
